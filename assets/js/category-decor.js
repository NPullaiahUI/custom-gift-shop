// Home Decor category JavaScript
...
const decorProducts = [
    {
        ...
        description: "Personalized wall art with your photos or custom design. Perfect for home decoration.",
        rating: 4.6,
        reviews: 156,
        sizes: ["8x10", "11x14", "16x20", "20x24"],
        materials: ["Canvas", "Metal", "Wood"]
    },
    {
        id: 32,
        ...
        description: "Custom decorative pillow with your design. Soft and comfortable for any room.",
        rating: 4.4,
        reviews: 87,
        sizes: ["12x12", "16x16", "18x18", "20x20"],
    ...
    },
    {
        ...
        description: "Personalized doormat with your custom text or design. Weather-resistant and durable.",
        rating: 4.3,
        reviews: 203,
        sizes: ["18x30", "24x36", "30x48"],
        materials: ["Coir", "Rubber", "Synthetic"]
    },
    {
        id: 34,
        ...
        description: "Beautiful wooden cutting board with custom engraving. Functional and decorative.",
        rating: 4.7,
        reviews: 142,
        sizes: ["12x8", "16x10", "20x12"],
        materials: ["Bamboo", "Oak", "Walnut"]
    },
    {
        id: 35,
        ...
        description: "Set of personalized coasters with your design. Protects surfaces in style.",
        rating: 4.2,
        reviews: 95,
        sizes: ["4 inch", "4.5 inch"],
        materials: ["Cork", "Wood", "Ceramic"]
    },
    {
        id: 36,
        ...
        price: 39.99,
        image: "https://images.unsplash.com/photo-1541961017774-22349e4a1262?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
        description: "Custom wall clock with your photos or design. Silent movement and modern style.",
        rating: 4.5,
        reviews: 78,
...
let filteredProducts = [...decorProducts];

// Initialize decor category
function initDecorCategory() {
    loadProducts();
    initSorting();
}
            ...
            <div class="product-card">
                <div class="product-image">
                    ...
                    <div class="product-badge">
                        <span class="badge bg-success">Handmade</span>
                    </div>
                </div>
...
function addToCartFromQuickView(productId) {
    ...
    addToCart(productId, quantity, design, { size, material });
